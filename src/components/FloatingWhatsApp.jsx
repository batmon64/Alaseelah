...
export default function FloatingWhatsApp() {
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-3 group cursor-pointer focus:outline-none focus:ring-4 focus:ring-green-400/50 rounded-2xl"
    ...
    >
      ...
      <motion.span
        ...
        className="hidden sm:block bg-slate-900 text-white text-xs font-semibold px-3 py-2 rounded-xl shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap pointer-events-none"
      >
        Chat with us
      </motion.span>
